      ...
      <div className="flex flex-col items-center gap-8 md:flex-row md:gap-16 lg:gap-20 xl:gap-24">
        ...
        <div className="relative md:order-1">
          <Image
            ...
            className="w-64 h-96 sm:w-72 sm:h-[27rem] md:w-80 md:h-[30rem] lg:w-96 lg:h-[36rem] xl:w-[26rem] xl:h-[39rem] object-cover border-8 md:border-[12px] lg:border-[15px] border-primary-500 shadow-[12px_12px_0_theme(colors.accent.500)] md:shadow-[16px_16px_0_theme(colors.accent.500)] lg:shadow-[20px_20px_0_theme(colors.accent.500)]"
          />
        </div>
        ...
        <div className="flex flex-col items-center text-center md:items-start md:text-left md:order-2">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold -mt-3 sm:-mt-4 md:-mt-6 lg:-mt-8 xl:-mt-10 underline decoration-accent-500 decoration-8 md:decoration-[12px] lg:decoration-[15px] xl:decoration-[18px] underline-offset-4 md:underline-offset-6 lg:underline-offset-8 xl:underline-offset-10">Germeck</h1>
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-primary-500 mt-3 md:mt-6 lg:mt-8">M.Sc. Software Engineer</h2>
        </div>
      </div>
      
      {/* Scroll Indicator */}
      {showScrollIndicator && (
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center text-primary-500 text-sm animate-bounce">
          <div className="w-5 h-5 border-r-2 border-b-2 border-accent-500 transform rotate-45 mb-2"></div>
